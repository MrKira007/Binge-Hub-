...
const EpisodeSelector = ({
  ...
  const [query, setQuery] = useState(1); // Season number
  ...
  const handleEpisodeClick = (episodeNumber: number) => {
    const apiUrl = `https://bingehubsrc.onrender.com/tv/${id}/${query}/${episodeNumber}`;
    window.location.href = apiUrl;  // Redirect to the API endpoint
  };
